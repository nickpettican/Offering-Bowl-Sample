...
export class DatabaseConstruct extends Construct {
    ...
    constructor(scope: Construct, id: string) {
        ...
        // Profile Table
        this.tables.Profile = new dynamodb.Table(this, "ProfilesTable", {
            tableName: "Profiles",
        ...
        this.tables.Profile.addGlobalSecondaryIndex({
            indexName: "userId-index",
            partitionKey: { name: "userId", type: dynamodb.AttributeType.STRING },
            projectionType: dynamodb.ProjectionType.ALL,
        });
        ...
        this.tables.Contracts.addGlobalSecondaryIndex({
            ...
            partitionKey: { name: "patronId", type: dynamodb.AttributeType.STRING },
            sortKey: { name: "monasticId", type: dynamodb.AttributeType.STRING },
            projectionType: dynamodb.ProjectionType.ALL,
        });
        ...
        this.tables.Posts.addGlobalSecondaryIndex({
            ...
            partitionKey: { name: "monasticId", type: dynamodb.AttributeType.STRING },
            projectionType: dynamodb.ProjectionType.ALL,
        });
